<script lang="ts">
  ...
  let faqs = [
    {
      question: 'What kind of tutors does ClassDeen look for?',
      answer:
    ...
    {
      question: 'What equipment do I need to teach on ClassDeen?',
...
<svelte:head>
  <title>Teach | ClassDeen</title>
  <meta property="og:image" itemprop="image" content="https://brand.cdn.clsrio.com/og/teach.png" />
  <meta property="og:title" content="Teach on ClassDeen" />
  <meta
    property="og:description"
    content="On ClassDeen you can make side income while doing what you love."
  />
  ...
  <PageHeader className="flex items-center justify-evenly px-5 flex-wrap text-left">
    <div>
      ...
      <p class="my-5 lg:w-[77%] lg:text-left text-center">
        With ClassDeen, you can make side income while teaching the subject you love
      </p>
    ...
    <div class="px-2 lg:px-[12%] bg-[#F5F8FE] my-10 py-12 h-[75%] lg:h-[80%]">
      ...
      >
        <h1 class="text-base font-medium leading-5 w-[77%] mx-auto">
          With ClassDeen, I am training over 100 students. I am making more money than expected with
          little effort and my students are happy. Love the product
        </h1>
